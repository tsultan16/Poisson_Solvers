...
!Scheme and Jacobi Iteration

program poisson2d_jacobi
implicit none
...
!filename=trim('Jacobi_N=')//trim(uniti)//trim('.txt')
open(unit=10,file=trim('Jacobi_N=')//trim(uniti)//trim('.txt'))
